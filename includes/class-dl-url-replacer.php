...
class Main
{
	...
	{
		add_menu_page(__('DL URL Replacer', 'dl-url-replacer') , __('DL URL Replacer', 'dl-url-replacer') , 'manage_options', 'dl-url-replacer', [$this, 'render_admin_page'], 'dashicons-admin-network', 80);
	}
